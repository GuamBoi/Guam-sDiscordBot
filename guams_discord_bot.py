...
# Define Rolles
silenced_role_name = 'YOUR_MUTE_ROLL'  # Name of the role to assign
...
suggestion_channel_id = YOUR_CHANNEL_ID
poll_channel_id = YOUR_CHANNEL_ID
ticket_category_id = YOUR_CATAGORY_ID # Make sure to use the ID of a catagory, not a channel
invite_channel_id = YOUR_CHANNEL_ID

# Bot Path Info
base_path = 'FILEPATH_TO_THIS_CODE' # This should be the filepath to YOUR code 
...
# Bot Token
client.run('YOUR_DISCORD_BOT_TOKEN') # Replace YOUR_BOT_TOKEN with your Discord Bot Token
